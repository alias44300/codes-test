...
public class MainActivity extends Activity {
    ...
    private void renderTools(){
        ...
        ui.gap(body,14);ui.add(body,ui.text("MARGE +  ·  VERSION 2.1.0",11,MUTED,true),8);ui.add(body,ui.text("Cette application est distincte de Marge. L’ancienne application et ses données restent intactes. L’import de son export reprend le total des frais, car cet export ne contient pas leur détail.",12,MUTED,false),0);
    }
